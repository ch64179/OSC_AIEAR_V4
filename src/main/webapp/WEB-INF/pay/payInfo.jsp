            ...
            <!-- //페이지타이틀 -->
                ...
                <div class="card">
                    ...
                    <form name="sendPayForm" id="sendPayForm" method="post">
                    	...
                    	<input type="hidden" name="returnUrl" value="${siteDomain}/afterPay.do?${_csrf.parameterName}=${_csrf.token}">
                    	<input type="hidden" name="closeUrl" value="${siteDomain}/closePay.do?${_csrf.parameterName}=${_csrf.token}">
				    ...
				    <button onclick="btnPay()" onclick="INIStdPay.pay('sendPayForm')" style="margin-top:50px">결제 요청</button>
                </div>
        </main>
    </body>
