...
<%--                     	<input type="hidden" name="closeUrl" value="http://103.22.220.93:8080/inicis/payInfo/${buyername}.do"> --%>
				    ...
				    <button id="btnPay" onclick="INIStdPay.pay('sendPayForm')" style="margin-top:50px; display:none;">결제 요청</button>
                </div>
        </main>
    </body>
